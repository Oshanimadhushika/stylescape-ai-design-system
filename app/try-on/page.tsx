...
import { Upload, Loader2, Download, RefreshCw, ImageIcon, Video, Lightbulb } from "lucide-react"
...
export default function TryOnPage() {
  ...
  const handleTryOn = async () => {
    ...
    try {
      ...
      alert(error instanceof Error ? error.message : "Try-on işlemi sırasında bir hata oluştu")
    } finally {
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <Card className="mb-6 border-primary/20 bg-primary/5">
          <CardHeader>
            ...
            <CardDescription>Kullanım senaryonuza göre önceden hazırlanmış profesyonel ayarlar</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Kaydedilmiş manken seçin veya yeni resim yükleyin</CardDescription>
            </CardHeader>
                ...
                {modelImage ? (
                  ...
                  <div className="flex h-full items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-muted-foreground">Manken seçin veya yükleyin</p>
                    </div>
                  </div>
                )}
              </div>
                ...
                <TabsContent value="saved" className="space-y-2">
                  {isLoadingModels ? (
                    ...
                    <div className="rounded-lg border border-dashed border-border bg-muted/50 p-8 text-center">
                      <p className="text-sm text-muted-foreground">Henüz kaydedilmiş manken yok</p>
                    </div>
                  ) : (
                        ...
                        {savedModels.map((model) => (
                          <button
                            ...
                            className={`flex w-full items-center gap-3 rounded-lg border p-3 text-left transition-colors hover:bg-accent ${
                              selectedModel?.id === model.id ? "border-primary bg-accent" : "border-border"
                            }`}
                          >
                            <img
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Denemek istediğiniz kıyafet resmini yükleyin</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="aspect-[2/3] overflow-hidden rounded-lg border-2 border-dashed border-border bg-muted">
                {clothingImage ? (
                  ...
                  <div className="flex h-full items-center justify-center">
                    <div className="text-center">
                      <ImageIcon className="mx-auto mb-2 h-12 w-12 text-muted-foreground" />
                      <p className="text-sm text-muted-foreground">Kıyafet resmi yükleyin</p>
                    </div>
                  </div>
                )}
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Try-on sonucunuz burada görünecek</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="aspect-[2/3] overflow-hidden rounded-lg border-2 border-border bg-muted">
                {result ? (
                  <img src={result || "/placeholder.svg"} alt="Try-on Result" className="h-full w-full object-cover" />
                ) : (
                  <div className="flex h-full items-center justify-center">
                    <div className="text-center">
                      <ImageIcon className="mx-auto mb-2 h-12 w-12 text-muted-foreground" />
                      <p className="text-sm text-muted-foreground">
                        {isProcessing ? "İşleniyor..." : "Sonuç burada görünecek"}
                      </p>
                    </div>
                  </div>
                )}
              ...
              {result && (
                <div className="space-y-2">
                  ...
                  <Button onClick={handleCreateVideo} className="w-full gap-2" size="lg">
        ...
        <Card className="mt-8">
          <CardHeader>
            ...
            <CardDescription>Çekiminizi özelleştirin ve marka kimliğinize uygun sonuçlar elde edin</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                ...
                <Select value={pose} onValueChange={setPose}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="casual-confident">Rahat & Özgüvenli</SelectItem>
                    <SelectItem value="dynamic-movement">Dinamik Hareket</SelectItem>
                    <SelectItem value="elegant-poised">Zarif & Duruşlu</SelectItem>
                    <SelectItem value="relaxed-natural">Rahat & Doğal</SelectItem>
                    <SelectItem value="three-quarter">3/4 Yan Duruş</SelectItem>
                    <SelectItem value="walking-stride">Yürüyüş Adımı</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select value={lighting} onValueChange={setLighting}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="natural-golden">Doğal Altın Saat</SelectItem>
                    <SelectItem value="studio-professional">Stüdyo Profesyonel</SelectItem>
              ...
              <div className="space-y-2">
                ...
                <Select value={environment} onValueChange={setEnvironment}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="urban-lifestyle">Şehir Yaşamı</SelectItem>
                    <SelectItem value="elegant-backdrop">Zarif Fon</SelectItem>
                    <SelectItem value="outdoor-natural">Açık Hava Doğal</SelectItem>
                    <SelectItem value="neutral-gray">Nötr Gri</SelectItem>
                    <SelectItem value="luxury-interior">Lüks İç Mekan</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
        ...
        <div className="mt-8 flex flex-col items-center gap-4">
          ...
          {!modelImage || !clothingImage ? (
            <p className="text-sm text-muted-foreground">Devam etmek için hem manken hem de kıyafet resmi yükleyin</p>
          ) : null}
        </div>
          ...
          <CardContent>
            <ul className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              <li className="flex gap-2 text-sm">
                ...
                <span className="text-muted-foreground">Yüksek çözünürlüklü resimler kullanın (min 1080p)</span>
              </li>
              <li className="flex gap-2 text-sm">
                <span className="text-primary">•</span>
                <span className="text-muted-foreground">Manken tam vücut veya üst gövde görünümünde olsun</span>
              </li>
              <li className="flex gap-2 text-sm">
                <span className="text-primary">•</span>
                <span className="text-muted-foreground">Kıyafet resmi düz, iyi ışıklandırılmış ve net olmalı</span>
              </li>
              <li className="flex gap-2 text-sm">
                <span className="text-primary">•</span>
                <span className="text-muted-foreground">Stüdyo ayarlarını marka kimliğinize göre seçin</span>
              </li>
              <li className="flex gap-2 text-sm">
                <span className="text-primary">•</span>
                <span className="text-muted-foreground">Tutarlılık için kaydedilmiş mankenleri tercih edin</span>
              </li>
              <li className="flex gap-2 text-sm">
                <span className="text-primary">•</span>
                <span className="text-muted-foreground">Hızlı başlangıç için hazır preset'leri kullanın</span>
              </li>
            </ul>
          </CardContent>
        </Card>
