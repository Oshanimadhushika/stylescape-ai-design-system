...
export default function CreateModelPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      alert(error instanceof Error ? error.message : "Manken kaydedilirken bir hata oluştu")
    } finally {
      setIsSaving(false)
    }
  }
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Mankenin temel özelliklerini belirleyin</CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Tutarlılık için detaylı fiziksel özellikleri belirleyin</CardDescription>
              </CardHeader>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={hairStyle} onValueChange={setHairStyle}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="kısa-dalgalı">Kısa Dalgalı</SelectItem>
                        <SelectItem value="orta-dalgalı">Orta Dalgalı</SelectItem>
                        <SelectItem value="uzun-dalgalı">Uzun Dalgalı</SelectItem>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Poz ve ortam ayarlarını belirleyin</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select value={pose} onValueChange={setPose}>
                    ...
                    <SelectContent>
                      <SelectItem value="dik-duruş">Dik Duruş (Frontal)</SelectItem>
                      <SelectItem value="yan-duruş">Yan Duruş (Profile)</SelectItem>
                      <SelectItem value="çeyrek-dönük">Çeyrek Dönük (3/4)</SelectItem>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={environment} onValueChange={setEnvironment}>
                    ...
                    <SelectContent>
                      <SelectItem value="stüdyo-beyaz">Stüdyo - Beyaz Arka Plan</SelectItem>
                      <SelectItem value="stüdyo-gri">Stüdyo - Gri Arka Plan</SelectItem>
                      <SelectItem value="stüdyo-renkli">Stüdyo - Renkli Arka Plan</SelectItem>
                      <SelectItem value="şehir-sokak">Şehir Sokak</SelectItem>
                      <SelectItem value="modern-iç-mekan">Modern İç Mekan</SelectItem>
                      <SelectItem value="doğal-ışık">Doğal Işık Ortamı</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </CardContent>
          ...
          <div>
            <Card className="sticky top-20">
              <CardHeader>
                ...
                <CardDescription>Oluşturulan mankeniniz burada görünecek</CardDescription>
              </CardHeader>
              <CardContent>
                {generatedImage ? (
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-2">
                      <Button onClick={handleSave} className="flex-1 gap-2" disabled={isSaving || !name.trim()}>
                        {isSaving ? (
                          <>
        ...
        <Card className="mt-8 border-primary/20 bg-primary/5">
          ...
          <CardContent>
            <ul className="list-inside list-disc space-y-2 text-sm text-muted-foreground">
              <li>Tüm fiziksel özellikleri detaylı belirleyin - aynı mankeni tekrar oluşturmak için kullanılacak</li>
              <li>Poz ve ortam seçiminiz kıyafet denemelerinde tutarlılık sağlar</li>
              <li>Kaydedilen mankenler try-on işlemlerinde tekrar kullanılabilir</li>
